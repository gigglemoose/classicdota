...
* **Aghanim's Shard**
* Some heroes do not have an Aghanim's Scepter upgrade, and many heroes have different upgrades than they do in modern Dota.
...
* Aghanim's Shard
* **Arcane, Swift, and Overwhelming Blink**
* Blight Stone
* Blitz Knuckles
* **Bloodthorn**
* Crown
...
Also, the farming triangle doesn't exist. The offlane only has the ancient camp. This contributes to the difficulty of the offlane and further nudges cores towards incorporating creep waves into their farming patterns.

#### Regen
Salves, clarities, and bottle charges get canceled by creep damage, whether they're neutral or enemy creeps. This makes all-in plays in the lane harder to pull off. It also means that spellcasting mid laners can't clear the jungle super quickly while keeping their mana levels high with clarities.
...
### Creeps are OP
Heroes are less powerful relative to creeps. Tanking the creep wave tends to be a very bad idea. Pushing waves is very time consuming (and can be very dangerous) if your hero isn't particularly good at it. It also takes most heroes slightly longer to clear neutral camps.

### More Down Time
When playing modern Dota, it feels as though the fighting never stops. It's common to reach two kills per minute, whereas this rarely happens in classic Dota. Excluding deathball and cheese strategies, players tend to heavily emphasize pushing lanes and clearing the jungle. The increased prevalence of split pushing makes it easier to avoid fights by forcing the enemy team back to base.

### Strengths and Weaknesses
It seems increasingly true in modern Dota that pretty much every hero is at least okay at doing most things. Valve uses a variety of mechanisms to bandage the weaknesses of heroes. There are talents that bandage or even straight up delete massive vulnerabilities, (e.g. Wraith King's No Reincarnation Manacost), base kit reworks (e.g. the jump forward that was added to Ursa's slow), and new aghs effects that solve a hero's problems (e.g. Sven's aghs... how the hell did they think that was a good idea?). Those last two make those two hard carries, whose biggest weakness has always been kiting, really hard to kite. Weaknesses are being increasingly removed from the game. When you take a roster of heroes that each has their own unique set of strengths and weaknesses and then delete the weaknesses, you're left with only strengths. You've removed half of the richness. Each hero is that much more similar to the others and something special is lost. 

When you're new to 6.84, your opponents' heroes might feel overpowered and your hero may very well feel useless. This is because just about every hero feels overpowered in ideal circumstances and almost completely worthless in bad circumstances and more experienced players draft with that in mind. If you don't punish your opponents' weaknesses, they'll have their strengths at no cost and seem overpowered. If you don't know your own strengths, your weaknesses will be punished but there will be no payoff. Every hero has very distinct and specific strengths and weaknesses in classic Dota. You have to pick your hero very carefully. You will win and lose games in the draft. You can't buy your way out of every bad situation, or wait for a talent to save you if you mess up and pick Wraith King against Anti-Mage or Phantom Lancer. When you can't fix your mistakes, it becomes even more important not to make them in the first place. Do things right the first time, or you will feel the consequences. **You must plan ahead - you cannot simply react.**
